...
read an example bigWig file with ChIP-seq signals^[Note, reading of bigWig files
is currently not supported on Windows. See `help(rtracklayer::import.bw)` for
more information. Users on Windows need to add ChIP-seq signals as `NumierList`
by other means.].
